...
public static class GameSaveHandlerRegistry
{
	...
	private static readonly IReadOnlyDictionary<string, IGameSaveHandler> Handlers =
		new Dictionary<string, IGameSaveHandler>(StringComparer.OrdinalIgnoreCase)
		{
			...
			["ninja-gaiden-2-black"] = new StandardGameSaveHandler("ninja-gaiden-2-black", StandardGameMappings.NinjaGaiden2Black),
			...
			["abiotic-factor-raw"] = new RawWgsExportHandler("abiotic-factor-raw"),
			["dragon-ball-xenoverse-2-raw"] = new RawWgsExportHandler("dragon-ball-xenoverse-2-raw"),
			[BrotatoHandler.HandlerId] = new BrotatoHandler(),
